...
public class ModItems {
    ...
    public static class RegistrationHandler {
        ...
        public static final ItemArmor.ArmorMaterial MATERIAL_ICHOR = EnumHelper.addArmorMaterial("ichor", LibMisc.MOD_ID + ":ichor", -1, new int[]{3, 6, 8, 3}, 22, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 2.0F);
        /**
        ...
        public static void registerItems(final RegistryEvent.Register<Item> event) {
            final Item[] items = {
                    ...
                    new IchorArmor("ichor_helm", MATERIAL_ICHOR, 1, EntityEquipmentSlot.HEAD, ThaumicTinkerer.getTab()),
                    new IchorArmor("ichor_chest", MATERIAL_ICHOR, 1, EntityEquipmentSlot.CHEST, ThaumicTinkerer.getTab()),
                    new IchorArmor("ichor_legs", MATERIAL_ICHOR, 2, EntityEquipmentSlot.LEGS, ThaumicTinkerer.getTab()),
                    new IchorArmor("ichor_boots", MATERIAL_ICHOR, 1, EntityEquipmentSlot.FEET, ThaumicTinkerer.getTab()),
