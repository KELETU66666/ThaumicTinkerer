...
public class ModRecipes {
    ...
    private static void initializeCauldronRecipes() {
        ...
        addCrucibleRecipe(LibRecipes.ENERGETIC_NITOR, new CrucibleRecipe(LibResearch.ENERGETIC_NITOR, new ItemStack(ModItems.energetic_nitor), new ItemStack(BlocksTC.nitor.get(EnumDyeColor.YELLOW)), new AspectList().add(Aspect.FIRE, 30).add(Aspect.AIR, 30).add(Aspect.LIGHT, 45).add(Aspect.ENERGY, 60)));
