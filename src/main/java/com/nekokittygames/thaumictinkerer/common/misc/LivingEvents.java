...
public class LivingEvents {
    ...
    public static void playerJumps(net.minecraftforge.event.entity.living.LivingEvent.LivingJumpEvent event) {
        ...
        if (event.getEntity() instanceof EntityPlayer && stack.getItem() instanceof ItemKamiArmor && stack.getItemDamage() != 1)
    ...
    public static void fall(LivingFallEvent e) {
        ...
        if (!boots.isEmpty() && boots.getItem() instanceof ItemKamiArmor && boots.getItemDamage() != 1) {
