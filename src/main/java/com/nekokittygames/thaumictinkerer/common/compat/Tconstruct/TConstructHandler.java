...
import com.nekokittygames.thaumictinkerer.common.compat.Tconstruct.fluid.TTFluidBlock;
...
public class TConstructHandler {
    ...
    public static final Block ichoriumFluidBlock = new TTFluidBlock(fluidIchorium, net.minecraft.block.material.Material.LAVA);
