...
import com.nekokittygames.thaumictinkerer.common.items.Kami.ItemChlorophyteArmor;
...
public class ModelChlorophyteArmor extends ModelCustomArmor {
	...
	public ModelChlorophyteArmor(float f) {
		super(f, 0, 128, 64);
		textureWidth = 128;
		textureHeight = 64;
		...
		cube_r1.cubeList.add(new ModelBox(cube_r1, 20, 35, -1.0F, -2.0F, 2.0F, 1, 2, 6, 0.0F, true));
		cube_r1.cubeList.add(new ModelBox(cube_r1, 20, 31, -1.0F, 0.0F, 1.0F, 1, 1, 3, 0.0F, true));

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(-5.0F, -9.0F, -2.0F);
		helm2.addChild(cube_r2);
		setRotationAngle(cube_r2, 0.5236F, -0.5236F, 0.0F);
		cube_r2.cubeList.add(new ModelBox(cube_r2, 20, 31, 0.0F, 0.0F, 1.0F, 1, 1, 3, 0.0F, false));
		cube_r2.cubeList.add(new ModelBox(cube_r2, 20, 35, 0.0F, -2.0F, 2.0F, 1, 2, 6, 0.0F, false));
		...
		cube_r3_r1.cubeList.add(new ModelBox(cube_r3_r1, 0, 27, -1.0F, 0.25F, -1.75F, 2, 1, 5, 0.0F, false));
		cube_r3_r1.cubeList.add(new ModelBox(cube_r3_r1, 20, 43, -1.0F, -1.75F, -1.75F, 2, 2, 6, 0.0F, false));
		...
		cube_r4_r1.setRotationPoint(2.0F, 9.7129F, 5.8013F);
		cube_r4.addChild(cube_r4_r1);
		setRotationAngle(cube_r4_r1, 0.2188F, 0.0859F, 0.0152F);
		cube_r4_r1.cubeList.add(new ModelBox(cube_r4_r1, 108, 53, 1.5F, -4.4F, -1.6F, 1, 3, 1, 0.0F, false));

		cube_r4_r2 = new ModelRenderer(this);
		cube_r4_r2.setRotationPoint(2.0F, 9.7129F, 5.8013F);
		cube_r4.addChild(cube_r4_r2);
		setRotationAngle(cube_r4_r2, 0.2182F, 0.0F, 0.0F);
		cube_r4_r2.cubeList.add(new ModelBox(cube_r4_r2, 108, 53, -2.5F, -4.4F, -1.6F, 1, 3, 1, 0.0F, true));
		...
		cube_r5_r1.setRotationPoint(2.0F, -2.1235F, -2.7941F);
		cube_r5.addChild(cube_r5_r1);
		setRotationAngle(cube_r5_r1, 0.3927F, 0.0F, 0.0F);
		cube_r5_r1.cubeList.add(new ModelBox(cube_r5_r1, 106, 57, 1.0F, 0.7581F, -0.6929F, 2, 6, 1, 0.0F, false));
		cube_r5_r1.cubeList.add(new ModelBox(cube_r5_r1, 106, 57, -3.0F, 0.7581F, -0.6929F, 2, 6, 1, 0.0F, true));

		cube_r5_r2 = new ModelRenderer(this);
		cube_r5_r2.setRotationPoint(2.0F, 6.9657F, 0.762F);
		cube_r5.addChild(cube_r5_r2);
		setRotationAngle(cube_r5_r2, -0.1134F, 0.0F, 0.0F);
		cube_r5_r2.cubeList.add(new ModelBox(cube_r5_r2, 106, 57, -3.0F, -2.5F, -1.9F, 2, 6, 1, 0.0F, true));

		cube_r5_r3 = new ModelRenderer(this);
		cube_r5_r3.setRotationPoint(2.0F, 6.9657F, 0.762F);
		cube_r5.addChild(cube_r5_r3);
		setRotationAngle(cube_r5_r3, -0.1144F, 0.0843F, -0.0226F);
		cube_r5_r3.cubeList.add(new ModelBox(cube_r5_r3, 106, 57, 1.0F, -2.5F, -1.9F, 2, 6, 1, 0.0F, false));
		...
		cube_r6_r1.setRotationPoint(0.0F, 0.0179F, -2.8481F);
		cube_r6.addChild(cube_r6_r1);
		setRotationAngle(cube_r6_r1, 0.1523F, 0.6153F, -0.2384F);
		cube_r6_r1.cubeList.add(new ModelBox(cube_r6_r1, 124, 49, -1.2931F, -7.6316F, -1.9407F, 1, 3, 1, 0.0F, true));
		...
		cube_r7_r1.setRotationPoint(0.0F, -0.8726F, -0.4755F);
		cube_r7.addChild(cube_r7_r1);
		setRotationAngle(cube_r7_r1, 0.1161F, 0.4153F, -0.5212F);
		cube_r7_r1.cubeList.add(new ModelBox(cube_r7_r1, 120, 53, -1.7931F, -5.5173F, -1.3649F, 2, 3, 2, 0.0F, true));
		...
		cube_r8_r1.setRotationPoint(0.0F, -0.4575F, 2.0245F);
		cube_r8.addChild(cube_r8_r1);
		setRotationAngle(cube_r8_r1, 0.1876F, 0.1219F, -0.6444F);
		cube_r8_r1.cubeList.add(new ModelBox(cube_r8_r1, 120, 58, -1.7931F, -3.3984F, -1.9234F, 2, 4, 2, 0.0F, true));
		...
		cube_r9_r1.setRotationPoint(0.0F, 0.0179F, -2.8481F);
		cube_r9.addChild(cube_r9_r1);
		setRotationAngle(cube_r9_r1, 0.1234F, -0.5841F, 0.2134F);
		cube_r9_r1.cubeList.add(new ModelBox(cube_r9_r1, 124, 49, 0.315F, -7.6343F, -1.8236F, 1, 3, 1, 0.0F, false));
		...
		cube_r10_r1.setRotationPoint(0.0F, -0.8726F, -0.4755F);
		cube_r10.addChild(cube_r10_r1);
		setRotationAngle(cube_r10_r1, 0.0879F, -0.3998F, 0.4842F);
		cube_r10_r1.cubeList.add(new ModelBox(cube_r10_r1, 120, 53, -0.185F, -5.4611F, -1.2622F, 2, 3, 2, 0.0F, false));
		...
		cube_r11_r1.setRotationPoint(0.0F, -0.4575F, 2.0245F);
		cube_r11.addChild(cube_r11_r1);
		setRotationAngle(cube_r11_r1, 0.1493F, -0.123F, 0.6068F);
		cube_r11_r1.cubeList.add(new ModelBox(cube_r11_r1, 120, 58, -0.185F, -3.2984F, -1.8626F, 2, 4, 2, 0.0F, false));
		...
		cube_r24.cubeList.add(new ModelBox(cube_r24, 12, 55, 1.5F, 3.0F, -2.5F, 1, 4, 5, 0.0F, false));
		...
		cube_r21.cubeList.add(new ModelBox(cube_r21, 12, 55, -1.5F, 1.0F, -2.5F, 1, 4, 5, 0.0F, true));
		cube_r21.cubeList.add(new ModelBox(cube_r21, 12, 55, -0.5F, -1.0F, -2.5F, 1, 4, 5, 0.0F, true));
		cube_r21.cubeList.add(new ModelBox(cube_r21, 12, 55, -2.5F, 3.0F, -2.5F, 1, 4, 5, 0.0F, true));
	...
	private void checkSet(Entity entity) {
		if (entity instanceof EntityLivingBase && entity.ticksExisted % 20 == 0) {
			...
			for (int a = 2; a < 5; ++a) {
				...
				if (piece != null && piece.getItem() instanceof ItemChlorophyteArmor) {
					++set;
					//if (a == 4) {
			...
			if (set > 0) {
				ModelChlorophyteArmor.hasSet.put(entity.getEntityId(), set);
			}
			else {
				ModelChlorophyteArmor.hasSet.remove(entity.getEntityId());
			}
		}
	}
	...
	static {
		ModelChlorophyteArmor.hasSet = new HashMap<Integer, Integer>();
	}
}